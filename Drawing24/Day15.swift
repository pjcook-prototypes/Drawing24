...
public struct Day15 {
    public var drawBoard: ((Board) -> Void)?
    public var displayLevel: ((Board) -> Void)?
    ...
    public func part1(_ input: [String]) -> Int {
        ...
        board.displayLevel = displayLevel
        board.explosion = explosion
        drawBoard?(board)
        board.play()
        board.results()
        return board.score
    ...
    public class Board {
        ...
        public func getTiles() -> [Point:Tile] {
            tiles
        }
